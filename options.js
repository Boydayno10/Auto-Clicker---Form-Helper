...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showExtensionWarningBanner() {
        ...
        banner.innerHTML = '<strong>Auto Clicker - Form Helper</strong>: extensão não detectada. As configurações não serão salvas. '
            + `<a id="acfh-install-link" href="${EXTENSION_INSTALL_URL}" target="_blank" rel="noopener noreferrer" style="color:#ffe082;text-decoration:underline;margin-left:8px;">Instalar</a>`;
    ...
    function showExtensionBlockedScreen() {
        ...
        blocker.innerHTML = `
            <div class="acfh-extension-card">
                <h2>Extensão não instalada</h2>
                <p>Para usar as configurações, instale a extensão <strong>Auto Clicker - Form Helper</strong> no navegador.</p>
                <a class="acfh-install-btn" href="${EXTENSION_INSTALL_URL}" target="_blank" rel="noopener noreferrer">Instalar extensão</a>
            </div>
        `;
